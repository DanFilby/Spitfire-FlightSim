...
void Mesh::Draw(GLuint programid)
{
    ...
    for (unsigned int i = 0; i < textures.size(); i++)
    {
        ...
        int uniformLoc = glGetUniformLocation(programid, ("material." + name + number).c_str());
...
{
    //load model, check for errors. then proccess 
...
//generate a texture from the given path
...
//generate a texture using a directory and a file name, used when model has multiple textures
